...
import { RouterModule } from "@angular/router";
import { ProceduresService } from "../../../core/services/procedures.service";
import { BehaviorSubject, Observable, of, switchMap, startWith, map } from "rxjs";
import { Procedure } from "../../../core/models/procedure.model";
...
export class ProceduresListComponent {
  ...
  constructor(private svc: ProceduresService) {
    ...
    // loading indicator toggles: start true -> load then false
    // we detect loading by switching to the first emission
